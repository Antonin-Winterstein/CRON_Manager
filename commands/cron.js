...
const scheduledSchema = require("../models/cron-schema");
...
module.exports = {
	...
	callback: async ({ message, args }) => {
		...
		// Retirer le tag du channel du tableau des arguments
		args.shift();
		...
		if (!validTimeZones.includes(timeZone)) {
			MessageEvent.reply("Unknown timezone!");
			return;
		}
